...
type CalculateServiceClient interface {
	PrimeCompose(ctx context.Context, in *CalculatorRequest, opts ...grpc.CallOption) (CalculateService_PrimeComposeClient, error)
...
func (c *calculateServiceClient) PrimeCompose(ctx context.Context, in *CalculatorRequest, opts ...grpc.CallOption) (CalculateService_PrimeComposeClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculateService_ServiceDesc.Streams[0], "/endtermPrimeCompostion.CalculateService/PrimeCompose", opts...)
	if err != nil {
		return nil, err
	}
	x := &calculateServicePrimeComposeClient{stream}
...
type CalculateService_PrimeComposeClient interface {
	Recv() (*CalculatorResponse, error)
	grpc.ClientStream
}

type calculateServicePrimeComposeClient struct {
	grpc.ClientStream
}

func (x *calculateServicePrimeComposeClient) Recv() (*CalculatorResponse, error) {
...
func (c *calculateServiceClient) ComputeAverage(ctx context.Context, opts ...grpc.CallOption) (CalculateService_ComputeAverageClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculateService_ServiceDesc.Streams[1], "/endtermPrimeCompostion.CalculateService/ComputeAverage", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *calculateServiceComputeAverageClient) Send(m *NumberRequest) error {
...
type CalculateServiceServer interface {
	PrimeCompose(*CalculatorRequest, CalculateService_PrimeComposeServer) error
...
func (UnimplementedCalculateServiceServer) PrimeCompose(*CalculatorRequest, CalculateService_PrimeComposeServer) error {
	return status.Errorf(codes.Unimplemented, "method PrimeCompose not implemented")
}
...
func _CalculateService_PrimeCompose_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(CalculatorRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CalculateServiceServer).PrimeCompose(m, &calculateServicePrimeComposeServer{stream})
}

type CalculateService_PrimeComposeServer interface {
	Send(*CalculatorResponse) error
	grpc.ServerStream
}

type calculateServicePrimeComposeServer struct {
	grpc.ServerStream
}

func (x *calculateServicePrimeComposeServer) Send(m *CalculatorResponse) error {
...
func (x *calculateServiceComputeAverageServer) Recv() (*NumberRequest, error) {
	m := new(NumberRequest)
...
var CalculateService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "endtermPrimeCompostion.CalculateService",
	HandlerType: (*CalculateServiceServer)(nil),
	Methods:     []grpc.MethodDesc{},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "PrimeCompose",
			Handler:       _CalculateService_PrimeCompose_Handler,
			ServerStreams: true,
		},
		{
